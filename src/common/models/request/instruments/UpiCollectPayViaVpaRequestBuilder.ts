...
import { VpaCollectPaymentDetails } from './VpaCollectPaymentDetails';
import { PgPaymentFlow } from '../../../../payments/v2/models/request/PgPaymentFlow';

export class UpiCollectPayViaVpaRequestBuilder {
    ...
    const paymentFlow: PaymentFlow = PgPaymentFlow.builder()
      .paymentMode(
        CollectPaymentV2Instrument.builder()
          .details(VpaCollectPaymentDetails.builder().vpa(this._vpa).build())
