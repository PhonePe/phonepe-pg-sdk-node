...
export class StandardCheckoutContants {
  static readonly PAY_API: string = '/checkout/v2/pay';
  ...
  static readonly TRANSACTION_STATUS_API =
    '/checkout/v2/transaction/{TRANSACTION_ID}/status';
